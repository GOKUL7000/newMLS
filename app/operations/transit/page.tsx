...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      <div><h1 className="text-2xl font-bold text-gray-800">In Transit</h1><p className="text-sm text-gray-500">Dashboard / Operations / In Transit</p></div>
      <div className="grid grid-cols-4 gap-4">
        {[{l:'In Transit',v:'20 Trips',c:'text-blue-600'},{l:'Total KM',v:'3,300 KM',c:'text-gray-700'},{l:'Est. Revenue',v:'₹ 7,31,000',c:'text-green-600'},{l:'Avg. KM / Trip',v:'550 KM',c:'text-purple-600'}].map((c,i)=>(
