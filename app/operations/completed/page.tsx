...
const trips = [
  { id: 'TRP1240', from: 'Coimbatore', to: 'Chennai', vehicle: 'TN 01 AB 1234', driver: 'Arun Kumar', startDate: '07 Jun 2026', customer: 'ABC Steels Pvt Ltd', freight: 125000, km: 510, status: 'Completed' },
  { id: 'TRP1241', from: 'Bangalore', to: 'Coimbatore', vehicle: 'TN 02 CD 5678', driver: 'Kumaravel', startDate: '07 Jun 2026', customer: 'Kaveri Industries', freight: 98000, km: 360, status: 'Completed' },
  { id: 'TRP1242', from: 'Chennai', to: 'Hyderabad', vehicle: 'TN 03 EF 9012', driver: 'Ramesh Babu', startDate: '06 Jun 2026', customer: 'Global Enterprises', freight: 145000, km: 630, status: 'Completed' },
  { id: 'TRP1243', from: 'Coimbatore', to: 'Mumbai', vehicle: 'TN 04 GH 3456', driver: 'Suresh', startDate: '05 Jun 2026', customer: 'Sri Venkateshwara Traders', freight: 210000, km: 1150, status: 'Completed' },
  { id: 'TRP1244', from: 'Madurai', to: 'Bangalore', vehicle: 'TN 05 IJ 7890', driver: 'Vijayakumar', startDate: '06 Jun 2026', customer: 'Sakthi Traders', freight: 88000, km: 440, status: 'Completed' },
  { id: 'TRP1245', from: 'Coimbatore', to: 'Trichy', vehicle: 'TN 06 KL 1122', driver: 'Prakash', startDate: '07 Jun 2026', customer: 'MJM Infra', freight: 65000, km: 210, status: 'Completed' },
];
...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      <div><h1 className="text-2xl font-bold text-gray-800">Completed Trips</h1><p className="text-sm text-gray-500">Dashboard / Operations / Completed Trips</p></div>
      <div className="grid grid-cols-4 gap-4">
        {[{l:'Completed Today',v:'12 Trips',c:'text-blue-600'},{l:'Total KM',v:'3,300 KM',c:'text-gray-700'},{l:'Est. Revenue',v:'₹ 7,31,000',c:'text-green-600'},{l:'Avg. KM / Trip',v:'550 KM',c:'text-purple-600'}].map((c,i)=>(
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-semibold text-gray-800">Completed Trips</h3>
          ...
          <tbody>
            {filtered.map((t,i)=>(
              <tr key={i} className="border-b border-gray-50 hover:bg-gray-50">
                ...
                <td className="py-3 pr-3"><span className="text-xs px-2 py-0.5 rounded-full bg-green-100 text-green-700">{t.status}</span></td>
