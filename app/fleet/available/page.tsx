...
const vehicles = [
  { no: 'TN 01 AB 1234', type: 'Truck', brand: 'Tata Motors', model: 'LPT 2518', year: 2021, driver: 'Arun Kumar', km: 128450, status: 'Available', insurance: '15 Aug 2026', permit: '20 Sep 2026', fc: '10 Oct 2026' },
  { no: 'TN 02 CD 5678', type: 'Truck', brand: 'Ashok Leyland', model: 'U-3718', year: 2020, driver: 'Kumaravel', km: 145200, status: 'Available', insurance: '12 Jun 2026', permit: '05 Jul 2026', fc: '22 Aug 2026' },
  { no: 'TN 03 EF 9012', type: 'Truck', brand: 'Tata Motors', model: 'LPT 3118', year: 2022, driver: 'Ramesh Babu', km: 98600, status: 'Available', insurance: '28 Sep 2026', permit: '15 Oct 2026', fc: '30 Nov 2026' },
  { no: 'TN 04 GH 3456', type: 'Truck', brand: 'BharatBenz', model: '3143R', year: 2021, driver: 'Suresh', km: 112300, status: 'Available', insurance: '30 Jul 2026', permit: '18 Aug 2026', fc: '25 Sep 2026' },
  { no: 'TN 05 IJ 7890', type: 'Truck', brand: 'Tata Motors', model: 'LPT 2518', year: 2019, driver: 'Vijayakumar', km: 198500, status: 'Available', insurance: '05 Jul 2026', permit: '12 Jun 2026', fc: '18 Jul 2026' },
  { no: 'TN 06 KL 1122', type: 'Truck', brand: 'Ashok Leyland', model: 'U-2518', year: 2022, driver: 'Prakash', km: 76400, status: 'Available', insurance: '22 Oct 2026', permit: '08 Nov 2026', fc: '15 Dec 2026' },
];
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      <div><h1 className="text-2xl font-bold text-gray-800">Available Vehicles</h1><p className="text-sm text-gray-500">Dashboard / Fleet / Available Vehicles</p></div>
      <div className="grid grid-cols-4 gap-4">
        {[{l:'Available Vehicles',v:'10 Vehicles',c:'text-blue-600'},{l:'Total KM (Avg)',v:'1,26,575 KM',c:'text-gray-700'},{l:'Oldest Vehicle',v:'2019 Model',c:'text-orange-500'},{l:'Newest Vehicle',v:'2022 Model',c:'text-green-600'}].map((c,i)=>(
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-semibold text-gray-800">Available Vehicles</h3>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>{filtered.map((v,i)=>(
            <tr key={i} className="border-b border-gray-50 hover:bg-gray-50">
              ...
              <td className="py-3 pr-3"><span className={`text-xs px-2 py-0.5 rounded-full bg-blue-100 text-blue-700`}>{v.status}</span></td>
