...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      <div><h1 className="text-2xl font-bold text-gray-800">Maintenance Due</h1><p className="text-sm text-gray-500">Dashboard / Fleet / Maintenance Due</p></div>
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-semibold text-gray-800">Maintenance Due — All Vehicles</h3>
        ...
        <table className="w-full text-sm">
          <thead><tr className="text-xs text-gray-500 border-b">{['Vehicle No.','Brand','Driver','Maintenance Due Date','Days Left','Est. Cost (₹)','Status',''].map((h,i)=><th key={i} className="text-left py-3 pr-3 font-medium">{h}</th>)}</tr></thead>
