    ...
    <div className="min-h-screen bg-gray-50 pb-8">
      ...
      <div className="bg-white border-b border-gray-100 px-4 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 font-bold text-[14px]">
            {session.name.charAt(0)}
          </div>
          <div>
            <p className="text-[14px] font-bold text-gray-800">{session.name}</p>
            <p className="text-[11px] text-gray-400">Supplier Portal</p>
          </div>
        </div>
      ...
      <div className="p-4 space-y-4 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
            ...
            <p className="text-[20px] font-bold text-red-500 mt-0.5">{inr(totalPayable)}</p>
          </div>
          <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
            <p className="text-[10px] text-gray-400">Total Received</p>
            <p className="text-[20px] font-bold text-green-600 mt-0.5">{inr(totalReceived)}</p>
          </div>
        </div>
