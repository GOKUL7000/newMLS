    ...
    <div className="min-h-screen bg-gray-50 pb-8">
      ...
      <div className="bg-white border-b border-gray-100 px-4 md:px-8 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 md:w-11 md:h-11 rounded-full bg-green-100 flex items-center justify-center text-green-600 font-bold text-[14px] md:text-base">
            {session.name.charAt(0)}
          </div>
          <div>
            <p className="text-[14px] md:text-base font-bold text-gray-800">{session.name}</p>
            <p className="text-[11px] md:text-xs text-gray-400">Customer Portal</p>
          </div>
        </div>
      ...
      <div className="p-4 md:p-8 space-y-4 md:space-y-6 max-w-2xl md:max-w-4xl lg:max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 md:gap-4">
          ...
          <div className="bg-white rounded-xl p-3 md:p-4 border border-gray-100 shadow-sm">
            ...
            <p className="text-[20px] md:text-2xl font-bold text-red-500 mt-0.5">{inr(totalOutstanding)}</p>
          </div>
          <div className="bg-white rounded-xl p-3 md:p-4 border border-gray-100 shadow-sm">
            <p className="text-[10px] md:text-xs text-gray-400">Total Paid</p>
            <p className="text-[20px] md:text-2xl font-bold text-green-600 mt-0.5">{inr(totalPaid)}</p>
          </div>
        </div>
